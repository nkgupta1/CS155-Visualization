...
\captionof{figure}{The only real correlation we found was in rating along one of the dimensions o$\widetilde{V}$.}
\end{minipage}
% Figure N+2
\begin{minipage}{0.48\linewidth}
