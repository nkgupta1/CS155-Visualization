...
\captionof{figure}{The coordinates of 10 randomly chosen films in the space of $\widetilde{V}$.}
\end{minipage}
...
\captionsetup{width=.85\linewidth}
\captionof{figure}{The 10 most popular films in the space of $\widetilde{V}$.}
\end{minipage}
% Figure N
\begin{minipage}{0.48\linewidth}
...
\captionsetup{width=.85\linewidth}
\captionof{figure}{The 10 films with the highest average ratings and over 50 total ratings in the space of $\widetilde{V}$}
\end{minipage}
\hfill % spread out row
% Figure N+1
\begin{minipage}{0.48\linewidth}
...
\captionsetup{width=.85\linewidth}
\captionof{figure}{The top 10 most popular films in the Fantasy genre, one of the three chosen in Basic Visualizations.}
\end{minipage}
% Figure N
\begin{minipage}{0.48\linewidth}
\label{appendix:viz-4}
\includegraphics[scale=0.35]{"Top 10 Genre: Sci-Fi Films"}
\captionsetup{width=.85\linewidth}
\captionof{figure}{The top 10 most popular films in the Sci-Fi genre, one of the three chosen in Basic Visualizations.}
\end{minipage}
\hfill % spread out row
% Figure N+1
\begin{minipage}{0.48\linewidth}
\label{appendix:viz-5}
\includegraphics[scale=0.35]{"Top 10 Genre: War Films"}
\captionsetup{width=.85\linewidth}
\captionof{figure}{The top 10 most popular films in the War genre, one of the three chosen in Basic Visualizations.}
\end{minipage}
\begin{minipage}{0.48\linewidth}
\label{appendix:viz-6}
\includegraphics[scale=0.35]{"All Movies"}
\captionsetup{width=.85\linewidth}
\captionof{figure}{Coordinates of all movies in the dataset shown in the space of $\widetilde{V}$.}
\end{minipage}
...
\captionsetup{width=.85\linewidth}
\captionof{figure}{All movies from 1998 are plotted here. No noticeable difference from all movies noticed here either.}
\end{minipage}
\end{center} 
